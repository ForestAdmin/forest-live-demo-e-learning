...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('quizzes');

// This file contains the logic of every route in Forest Admin for the collection quizzes:
...
// Create a Quiz
router.post('/quizzes', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Quiz
router.put('/quizzes/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Quiz
router.delete('/quizzes/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/quizzes', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Quizzes
router.get('/quizzes/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Quiz
router.get('/quizzes/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Quizzes
router.get('/quizzes.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Quizzes
router.delete('/quizzes', permissionMiddlewareCreator.delete(), (request, response, next) => {
